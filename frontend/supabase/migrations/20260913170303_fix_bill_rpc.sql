-- Fix the create_bill_with_items RPC
-- 1. Use p_payment_method::payment_type instead of TEXT to avoid type mismatch
-- 2. Do not insert bill_number manually; let the BEFORE INSERT trigger handle it
